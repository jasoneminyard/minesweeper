...
# lets create a boad object to prepresent the minesweeper game
# this is s o that we can just say create a new board object", or
# "dig here", or "render this game for theis object"
class Board:
    def __init__(self, dim_size, num_bombs):
        ...
        # helper function!
        self.board = self.make_new_board() # and plant the bombs
    ...
    def make_new_board(self):
        ...
        while bombs_planted < self.num_bombs:
            ...
            bombs_planted += 1    # increment number of bombs planted

        return board
    
    def assign_values_to_board(self):
        print("assign_values_to_board")
        # now that we have the bombs planted, let's assign a number 0-8 for all the emply spaces, which
        # represents how many neighboring bombs there are.  we can precompute these and it'll save some
        # effor checking what's around the board later on
    ...
    def get_num_neighboring_bombs(self, row, col):
        print("inside get_num_neighboring_bombs")
    ...
    def dig(self, row, col):
        ...
        # dig at location with no neighboriing bombs -> recursively dig neighbors
        ...
        for r in range(max(0, row-1), min(self.dim_size-1, row+1)):
            for c in range(max(0, col-1), min(self.dim_size, col+1)):
                if (r, c) in self.dug:
